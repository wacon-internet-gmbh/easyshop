...
namespace Wacon\Easyshop\Upgrades;
...
#[UpgradeWizard('easyshop_migrateToCTypeUpgradeWizard')]
final class MigrateToCTypeUpgradeWizard implements UpgradeWizardInterface
{
    ...
    {
        return 'Easyshop: Migrate list_type plugins to CType';
    }
    ...
    {
        return 'Change db value list_type to CType for easyshop plugins';
    }
    ...
    public function executeUpdate(): bool
    {
        ...
        $queryBuilder
            ->update('tt_content')
            ->where(
                $queryBuilder->expr()->like('list_type', $queryBuilder->createNamedParameter($queryBuilder->escapeLikeWildcards('easyshop') . '_%', Connection::PARAM_STR)),
