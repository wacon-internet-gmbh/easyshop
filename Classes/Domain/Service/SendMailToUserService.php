...
class SendMailToUserService extends SendMailService
{
    use ExtensionTrait;
    ...
    public function send(array $orderDetails): void
    {
        ...
        $fluidEmail
            ->to($orderDetails['payment_source']['paypal']['email_address'])
            ->from(new Address($this->settings['emails']['orderConfirmation']))
